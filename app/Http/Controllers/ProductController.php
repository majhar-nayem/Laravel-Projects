...
class ProductController extends Controller
{
    ...
    public function publishedProduct($id){
        $publishedProductById = Product::find($id);
        $publishedProductById->publication_status= 1;
        $publishedProductById->save();

        return redirect('/product/manage-product')->with('message','Product Published Successfully!');
